    ...
    <footer className="bg-background border-t">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="font-bold text-lg mb-4">ARTIFEX</h3>
            <p className="text-muted-foreground">Discover and collect unique artworks from artists around the world.</p>
          ...
          <div>
            <h4 className="font-medium text-base mb-4">Information</h4>
            <ul className="space-y-2">
              <li>
